...
var <- c(#'CBL_80', 'd_80', 'alphaAnt_80', 'alphaPos_80', 'DAnt_80', 'DPos_80', 
         ...
         'dBW_mn', 'DAntBW_mn', 'DPosBW_mn')
         #'dBW_slope', 'DAntBW_slope', 'DPosBW_slope',
         #'dBW_quad', 'DAntBW_quad', 'DPosBW_quad',
...
```
```{r}
emmeans(modeltests$model[[5]], ~Habitat)
```

```{r}
ggplot(vertdata_sp0, aes(x = Habitat, y = d_mn)) +
  geom_point()
```
