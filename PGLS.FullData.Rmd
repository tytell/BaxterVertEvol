...
f1 <- ggplot(fullvertmeas.speciesall, aes(x=Habitat, y=d_mean, color=Habitat, shape=Habitat)) +
  ...
  geom_quasirandom(alpha = 0.4, width=0.3) +
  stat_summary(fun.data = mean_sdl, size=0.6) +
...
((f2 / f3 / f1) + plot_layout(guides="collect")) & my_theme
ggsave('fig_means.pdf', width=4, height=5, units="in")
```

```{r}
knitr::include_graphics('fig_means.pdf')
```
