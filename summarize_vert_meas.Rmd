...
```{r}
here(i_am("Code/summarize_vert_meas.Rmd"))
```

## Vertebral measurements

```{r}
vertdata <- read_csv(here('Processed Data', "MasterVert_Measurements_Matched.csv")) %>%
...
```{r}
write_csv(vertdata2, here('Processed Data', "vertdata_centered.csv"))
```
...
```{r}
write_csv(vertdata_summary, here("Processed Data", "vertdata_summary.csv"))
```
