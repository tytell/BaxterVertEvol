...
```{r}
missingfish <- c("Roeboides affinis","Stenobrachius leucopsaurus","Ammodytes personatus","Onchorhyncus gorbuscha")
```
...
```{r}
missingdat <- species(fish, fields=c("BodyShapeI", "DepthRangeShallow", "DepthRangeDeep", "DepthRangeComShallow", "DepthRangeComDeep", "Length", "CommonLength", "Weight", "DemersPelag"))
```
