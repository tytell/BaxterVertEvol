...
Missing: Roeboides affinis (on Fishbase), Stenobrachius leucopsaurus (on Fishbase), Onchorhyncus gorbuscha (misspelled), Ammodytes personatus (on Fishbase), Anoplarchus pupurescens (misspelled)
